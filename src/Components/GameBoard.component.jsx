...
function GameBoard({
  ...
  const OnSubGamedWin = (majorGamesIndex, winner) => {
    ...
    if(winner === 1){
      alert( "O vencedor do tabuleiro " + majorGamesIndex + " foi o \"" + playerOneName + "\"")
    }else if(winner === -1){
      alert( "O vencedor do tabuleiro " + majorGamesIndex + " foi o \"" + playerTwoName + "\"")
    }else{
      alert( "O tabuleiro " + majorGamesIndex + " acabou em empate")
    }
